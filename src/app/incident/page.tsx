        ...
        <div style={{ display: 'flex', justifyContent: 'center', marginTop: '8rem' }}>
          <div style={{ color: 'var(--color-pure-white)', textAlign: 'center', maxWidth: '520px' }}>
            ...
            <p style={{ color: 'var(--color-gray-light)', marginTop: '1rem' }}>
              DEPT-SEC clearance required. Active incident coordination is restricted to authorized security personnel.
            </p>
            <p style={{ marginTop: '2rem' }}>
              <Link href="/security" className={styles.link}>&larr; Return to Security Center</Link>
            </p>
          </div>
        </div>
      </main>
